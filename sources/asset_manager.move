...
module protocol_75::asset_manager {
    ...
    #[test_only]
    public fun has_yield_position(user: address): bool {
        exists<YieldPosition>(user)
    }

    #[test_only]
    public fun has_report_bond(user: address): bool {
        exists<ReportBond>(user)
    }
    ...
    #[test_only]
    friend protocol_75::asset_manager_tests;
}
